...
//初始化处理bean
web.filename = config.getServletContext().getRealPath("/")+"system/help/webeditor/config/style.xml";
web.filename2 = config.getServletContext().getRealPath("/")+"system/help/webeditor/config/button.xml";
web.getInstance();
//初始化输出bean
...
<body SCROLLING=no onConTextMenu="event.returnValue=false;" onfocus="VerifyFocus()" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
