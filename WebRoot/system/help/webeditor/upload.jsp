...
<%@ page import="combiz.system.common.upload.*"%>
...
public void InitUpload(String realpath){
	...
	uw.filename = realpath+"system/help/webeditor/config/style.xml";
	uw.getInstance();
  ...
  //DoSave();
   ...
   //设置上传文件类型
	...
	// Retreive the current file
		combiz.system.common.upload.File myFile = up.getFiles().getFile(i);
		if (!myFile.isMissing()) {
