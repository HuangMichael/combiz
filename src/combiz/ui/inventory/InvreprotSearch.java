...
import combiz.business.inventory.InvreportSrv;
...
public class InvreprotSearch extends SearchWindow {
	...
	public void search() throws Exception {
		...
		LaborSrv laborSrv;
 		...
 		InvreportSrv invreportsrv = (InvreportSrv)IBOSrvUtil.getSrv("invreport");
		SBandbox sband = (SBandbox) this.getFellow("invreport.warehouse");
		...
		if(Util.isNull(entersite))
		{
 		...
 		SCombobox syear = (SCombobox) this.getFellow("invreport.thisdate");
		...
		SCombobox smon = (SCombobox) this.getFellow("invreport.orderdesc");
