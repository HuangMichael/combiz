...
public class FldSumcurbal extends FieldAdapter {
	...
	public Object initValue() throws Exception {
		...
		sumcurbal = (Double) this.getMainSrv().getBaseDao().selectSumByHql("select sum(t.curbal) from Invstock t where  t.itemnum = '"+inv.getItemnum()+"' and t.warehouse = '"+inv.getWarehouse()+"' ");
		if(sumcurbal == null)
			sumcurbal = 0d;
		return sumcurbal;
	}
