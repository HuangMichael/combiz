...
public class InvtransprotSearch extends SearchWindow {
	...
	public void search() throws Exception {
		...
		LaborSrv laborSrv;
 		...
 		InvtransSrv invreportsrv = (InvtransSrv)IBOSrvUtil.getSrv("invtrans");
		SBandbox sband = (SBandbox) this.getFellow("invtrans.warehouse");
		...
		if(Util.isNull(entersite))
		{
 		...
 		SCombobox syear = (SCombobox) this.getFellow("invtrans.transdate");
		...
		SCombobox smon = (SCombobox) this.getFellow("invtrans.quantity");
