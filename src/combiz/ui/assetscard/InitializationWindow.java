...
import combiz.business.assetscard.AssetscardSrv;
...
public class InitializationWindow extends MainWindow
implements InfWindow
{
	...
	public void initialization() throws Exception {
		...
		Assetscard assetscard = (Assetscard) this.mainObject;
		
			((AssetscardSrv) this.getMainSrv()).insert();
			this.clear();
	...
	public void antiinitialization() throws Exception {
		
		Assetscard assetscard = (Assetscard) this.mainObject;
		
			((AssetscardSrv) this.getMainSrv()).uninsert();
			this.clear();
			Messagebox.show("反初始化完成！");
	...
	{
		//添加用户自己的代码
	//	this.setReadonlyList(true); 全表变为只读
	}
