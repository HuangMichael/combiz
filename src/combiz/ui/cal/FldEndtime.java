...
extends FieldAdapter 
{
	...
	throws Exception 
	{
		ITimebox itextbox = (ITimebox)component;
		String endtimestr = itextbox.getValue();
		if(endtimestr!=null && endtimestr.length()>0)
		{	
			//计算时差
			String starttimestr = (String) this.getValueByColname("starttime");
