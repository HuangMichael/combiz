...
public class FindclassOfItemTree extends LookupTree
{
	ClassificationSrv classificationSrv;
	
	public FindclassOfItemTree() 
	{
		super();
	}
...
//		清除树，重新构建
		...
		{
			this.createChildRoot(list, treeitem_eqclass);
		}
	...
	//由createroot方法调用
	private void createChildRoot(List list,Treeitem parentTi)
	throws Exception
	{
