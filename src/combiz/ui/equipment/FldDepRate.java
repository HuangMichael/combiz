...
public class FldDepRate extends FieldAdapter{

	@Override
	public void action(Component arg0) throws Exception {
		Equipdep equipdep = (Equipdep)this.mainObject;
		if(equipdep.getDeprate() !=null && equipdep.getEqnum() !=null){
			...
			if(list!=null && list.size()>0){
				...
				double result = equip.getTotalcost() * equipdep.getDeprate();
				this.setValueByColname("depcost", Util.doubleTodouble(result));
