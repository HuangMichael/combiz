...
public class EqdowntimeRate1 implements KpiCustomValue{
...
//		List list = IBOSrvUtil.getBaseDao().findWithQuery(Equipment.class,"eqnum='10000028'");
//		Double obj = (Double)IBOSrvUtil.getBaseSrv().getBaseDao().selectSumByHql("select sum(e.downtime) from Eqdowntime e where e.eqnum='10000028'");
