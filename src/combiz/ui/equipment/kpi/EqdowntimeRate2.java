...
public class EqdowntimeRate2 implements KpiCustomValue{
...
//		List list = IBOSrvUtil.getBaseDao().findWithQuery(Equipment.class,"eqnum='10000031'");
//		Double obj = (Double)IBOSrvUtil.getBaseSrv().getBaseDao().selectSumByHql("select sum(e.downtime) from Eqdowntime e where e.eqnum='10000031'");
